...
// Value *PrintError(const char *description) {
//     fprintf(stderr, "\033[1mirbuilder\033[0m: \033[31m\033[1merror:\033[0m %s\n", description);
//     return nullptr;
// }
...
// Value *NumberAST::GenIR() {
//     return ConstantInt::get(context, APInt(64, value_, true));
// }

// Value *DecimalAST::GenIR() {
//     return ConstantFP::get(context, APFloat(value_));
// }

// Value *StringAST::GenIR() {
//     // TODO
//     return builder.CreateGlobalString(str_);
// }

// Value *BinaryExpressionAST::GenIR() {
//     SSAPtr value;
//     auto cur_block = irb.GetCurrentBlock();
...
// Value *UnaryExpressionAST::GenIR() {
//     SSAPtr value;
//     auto cur_block = irb.GetCurrentBlock();
